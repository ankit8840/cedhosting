					...
					<div class="container">
						<div class="footer-grids">
							...
							<div class="col-md-3 footer-grid">
								...
								<p>Telephone : +1 234 567 890</p>
								<p>E-mail : <a href="mailto:example@mail.com">ankitdixit.9502@gmail.com</a></p>
							</div>
							<div class="clearfix"></div>
						</div>
						<div class="copy-section">
							<p>&copy; 2020 Planet Hosting. All rights reserved | Design by <a href="http://w3layouts.com">Ankit Dixit</a></p>
						</div>
					</div>
				</div>
			<!---footer--->
